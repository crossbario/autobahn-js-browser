...
(function(c){c(function(c){function a(a,b,e,c){return(a instanceof d?a:h(a)).then(b,e,c)}function b(a){return new d(a,D.PromiseStatus&&D.PromiseStatus())}function d(a,b){function d(a){if(r){var d=r;r=x;n(function(){k=e(C,a);b&&A(k,b);f(d,k)})}}function c(a){d(new l(a))}function h(a){if(r){var b=r;n(function(){f(b,new g(a))})}}var k,r=[];var C=this;this._status=b;this.inspect=function(){return k?k.inspect():{state:"pending"}};this._when=function(a,b,e,d,c){function f(f){f._when(a,b,e,d,c)}r?r.push(f):
n(function(){f(k)})};try{a(d,c,h)}catch(K){c(K)}}function h(a){return b(function(b){b(a)})}function f(a,b){for(var e=0;e<a.length;e++)a[e](b)}function e(a,b){if(b===a)return new l(new TypeError);if(b instanceof d)return b;try{var e=b===Object(b)&&b.then;return"function"===typeof e?k(e,b):new m(b)}catch(F){return new l(F)}}function k(a,e){return b(function(b,d){I(a,e,b,d)})}function m(a){this.value=a}function l(a){this.value=a}function g(a){this.value=a}function A(a,b){a.then(function(){b.fulfilled()},
function(a){b.rejected(a)})}function t(a){return a&&"function"===typeof a.then}function B(e,d,c,f,h){return a(e,function(e){return b(function(b,c,f){function h(a){g(a)}function A(a){C(a)}var k;var r=e.length>>>0;var t=Math.max(0,Math.min(d,r));var l=[];var B=r-t+1;var w=[];if(t){var g=function(a){w.push(a);--B||(C=g=p,c(w))};var C=function(a){l.push(a);--t||(C=g=p,b(l))};for(k=0;k<r;++k)k in e&&a(e[k],A,h,f)}else b(l)}).then(c,f,h)})}function w(a,b,e,d){return u(a,p).then(b,e,d)}function u(b,e,c){return a(b,
function(b){return new d(function(d,f,h){function k(b,k){a(b,e,c).then(function(a){r[k]=a;--l||d(r)},f,h)}var A,t;var l=A=b.length>>>0;var r=[];if(l)for(t=0;t<A;t++)t in b?k(b[t],t):--l;else d(r)})})}function z(a){return{state:"fulfilled",value:a}}function y(a){return{state:"rejected",reason:a}}function n(a){1===G.push(a)&&E(v)}function v(){f(G);G=[]}function p(a){return a}function O(a){"function"===typeof D.reportUnhandled?D.reportUnhandled():n(function(){throw a;});throw a;}a.promise=b;a.resolve=
h;a.reject=function(b){return a(b,function(a){return new l(a)})};a.defer=function(){var a,e;var d={promise:x,resolve:x,reject:x,notify:x,resolver:{resolve:x,reject:x,notify:x}};d.promise=a=b(function(b,c,f){d.resolve=d.resolver.resolve=function(d){if(e)return h(d);e=!0;b(d);return a};d.reject=d.resolver.reject=function(b){if(e)return h(new l(b));e=!0;c(b);return a};d.notify=d.resolver.notify=function(a){f(a);return a}});return d};a.join=function(){return u(arguments,p)};a.all=w;a.map=function(a,b){return u(a,
b)};a.reduce=function(b,e){var d=I(J,arguments,1);return a(b,function(b){var c=b.length;d[0]=function(b,d,f){return a(b,function(b){return a(d,function(a){return e(b,a,f,c)})})};return P.apply(b,d)})};a.settle=function(a){return u(a,z,y)};a.any=function(a,b,e,d){return B(a,1,function(a){return b?b(a[0]):a[0]},e,d)};a.some=B;a.isPromise=t;a.isPromiseLike=t;var q=d.prototype;q.then=function(a,b,e){var c=this;return new d(function(d,f,h){c._when(d,h,a,b,e)},this._status&&this._status.observed())};q["catch"]=
q.otherwise=function(a){return this.then(x,a)};q["finally"]=q.ensure=function(a){function b(){return h(a())}return"function"===typeof a?this.then(b,b).yield(this):this};q.done=function(a,b){this.then(a,b)["catch"](O)};q.yield=function(a){return this.then(function(){return a})};q.tap=function(a){return this.then(a).yield(this)};q.spread=function(a){return this.then(function(b){return w(b,function(b){return a.apply(x,b)})})};q.always=function(a,b){return this.then(a,a,b)};var H=Object.create||function(a){function b(){}
b.prototype=a;return new b};m.prototype=H(q);m.prototype.inspect=function(){return z(this.value)};m.prototype._when=function(a,b,e){try{a("function"===typeof e?e(this.value):this.value)}catch(F){a(new l(F))}};l.prototype=H(q);l.prototype.inspect=function(){return y(this.value)};l.prototype._when=function(a,b,e,d){try{a("function"===typeof d?d(this.value):this)}catch(M){a(new l(M))}};g.prototype=H(q);g.prototype._when=function(a,b,e,d,c){try{b("function"===typeof c?c(this.value):this.value)}catch(L){b(L)}};
var x;var G=[];var D="undefined"!==typeof console?console:a;if("object"===typeof process&&process.nextTick)var E=process.nextTick;else if(q="function"===typeof MutationObserver&&MutationObserver||"function"===typeof WebKitMutationObserver&&WebKitMutationObserver)E=function(a,b,e){var d=a.createElement("div");(new b(e)).observe(d,{attributes:!0});return function(){d.setAttribute("x","x")}}(document,q,v);else try{E=c("vertx").runOnLoop||c("vertx").runOnContext}catch(r){var Q=setTimeout;E=function(a){Q(a,
0)}}c=Function.prototype;q=c.call;var I=c.bind?q.bind(q):function(a,b){return a.apply(b,J.call(arguments,2))};c=[];var J=c.slice;var P=c.reduce||function(a){var b=0;var e=Object(this);var d=e.length>>>0;var c=arguments;if(1>=c.length)for(;;){if(b in e){c=e[b++];break}if(++b>=d)throw new TypeError;}else c=c[1];for(;b<d;++b)b in e&&(c=a(c,e[b],b,e));return c};return a})})("function"===typeof define&&define.amd?define:function(c){module.exports=c(require)});var CryptoJS=CryptoJS||function(c,g){var a={},b=a.lib={},d=b.Base=function(){function a(){}return{extend:function(b){a.prototype=this;var e=new a;b&&e.mixIn(b);e.hasOwnProperty("init")||(e.init=function(){e.$super.init.apply(this,arguments)});e.init.prototype=e;e.$super=this;return e},create:function(){var a=this.extend();a.init.apply(a,arguments);return a},init:function(){},mixIn:function(a){for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b]);a.hasOwnProperty("toString")&&(this.toString=a.toString)},
clone:function(){return this.init.prototype.extend(this)}}}(),h=b.WordArray=d.extend({init:function(a,b){a=this.words=a||[];this.sigBytes=b!=g?b:4*a.length},toString:function(a){return(a||e).stringify(this)},concat:function(a){var b=this.words,e=a.words,d=this.sigBytes;a=a.sigBytes;this.clamp();if(d%4)for(var c=0;c<a;c++)b[d+c>>>2]|=(e[c>>>2]>>>24-c%4*8&255)<<24-(d+c)%4*8;else if(65535<e.length)for(c=0;c<a;c+=4)b[d+c>>>2]=e[c>>>2];else b.push.apply(b,e);this.sigBytes+=a;return this},clamp:function(){var a=
this.words,b=this.sigBytes;a[b>>>2]&=4294967295<<32-b%4*8;a.length=c.ceil(b/4)},clone:function(){var a=d.clone.call(this);a.words=this.words.slice(0);return a},random:function(a){for(var b=[],e=0;e<a;e+=4)b.push(4294967296*c.random()|0);return new h.init(b,a)}}),f=a.enc={},e=f.Hex={stringify:function(a){var b=a.words;a=a.sigBytes;for(var e=[],d=0;d<a;d++){var c=b[d>>>2]>>>24-d%4*8&255;e.push((c>>>4).toString(16));e.push((c&15).toString(16))}return e.join("")},parse:function(a){for(var b=a.length,
e=[],d=0;d<b;d+=2)e[d>>>3]|=parseInt(a.substr(d,2),16)<<24-d%8*4;return new h.init(e,b/2)}},k=f.Latin1={stringify:function(a){var b=a.words;a=a.sigBytes;for(var e=[],d=0;d<a;d++)e.push(String.fromCharCode(b[d>>>2]>>>24-d%4*8&255));return e.join("")},parse:function(a){for(var b=a.length,e=[],d=0;d<b;d++)e[d>>>2]|=(a.charCodeAt(d)&255)<<24-d%4*8;return new h.init(e,b)}},m=f.Utf8={stringify:function(a){try{return decodeURIComponent(escape(k.stringify(a)))}catch(t){throw Error("Malformed UTF-8 data");
}},parse:function(a){return k.parse(unescape(encodeURIComponent(a)))}},l=b.BufferedBlockAlgorithm=d.extend({reset:function(){this._data=new h.init;this._nDataBytes=0},_append:function(a){"string"==typeof a&&(a=m.parse(a));this._data.concat(a);this._nDataBytes+=a.sigBytes},_process:function(a){var b,e=this._data,d=e.words,f=e.sigBytes,k=this.blockSize,l=f/(4*k),l=a?c.ceil(l):c.max((l|0)-this._minBufferSize,0);a=l*k;f=c.min(4*a,f);if(a){for(b=0;b<a;b+=k)this._doProcessBlock(d,b);b=d.splice(0,a);e.sigBytes-=
f}return new h.init(b,f)},clone:function(){var a=d.clone.call(this);a._data=this._data.clone();return a},_minBufferSize:0});b.Hasher=l.extend({cfg:d.extend(),init:function(a){this.cfg=this.cfg.extend(a);this.reset()},reset:function(){l.reset.call(this);this._doReset()},update:function(a){this._append(a);this._process();return this},finalize:function(a){a&&this._append(a);return this._doFinalize()},blockSize:16,_createHelper:function(a){return function(b,e){return(new a.init(e)).finalize(b)}},_createHmacHelper:function(a){return function(b,
e){return(new N.HMAC.init(a,e)).finalize(b)}}});var N=a.algo={};return a}(Math);(function(){var c=CryptoJS,g=c.lib.WordArray;c.enc.Base64={stringify:function(a){var b=a.words,d=a.sigBytes,c=this._map;a.clamp();a=[];for(var f=0;f<d;f+=3)for(var e=(b[f>>>2]>>>24-f%4*8&255)<<16|(b[f+1>>>2]>>>24-(f+1)%4*8&255)<<8|b[f+2>>>2]>>>24-(f+2)%4*8&255,k=0;4>k&&f+.75*k<d;k++)a.push(c.charAt(e>>>6*(3-k)&63));if(b=c.charAt(64))for(;a.length%4;)a.push(b);return a.join("")},parse:function(a){var b=a.length,d=this._map,c=d.charAt(64);c&&(c=a.indexOf(c),-1!=c&&(b=c));for(var c=[],f=0,e=0;e<b;e++)if(e%
4){var k=d.indexOf(a.charAt(e-1))<<e%4*2,m=d.indexOf(a.charAt(e))>>>6-e%4*2;c[f>>>2]|=(k|m)<<24-f%4*8;f++}return g.create(c,f)},_map:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="}})();(function(){var c=CryptoJS,g=c.enc.Utf8;c.algo.HMAC=c.lib.Base.extend({init:function(a,b){a=this._hasher=new a.init;"string"==typeof b&&(b=g.parse(b));var d=a.blockSize,c=4*d;b.sigBytes>c&&(b=a.finalize(b));b.clamp();for(var f=this._oKey=b.clone(),e=this._iKey=b.clone(),k=f.words,m=e.words,l=0;l<d;l++)k[l]^=1549556828,m[l]^=909522486;f.sigBytes=e.sigBytes=c;this.reset()},reset:function(){var a=this._hasher;a.reset();a.update(this._iKey)},update:function(a){this._hasher.update(a);return this},finalize:function(a){var b=
this._hasher;a=b.finalize(a);b.reset();return b.finalize(this._oKey.clone().concat(a))}})})();(function(c){var g=CryptoJS,a=g.lib,b=a.WordArray,d=a.Hasher,a=g.algo,h=[],f=[];(function(){function a(a){for(var b=c.sqrt(a),e=2;e<=b;e++)if(!(a%e))return!1;return!0}function b(a){return 4294967296*(a-(a|0))|0}for(var e=2,d=0;64>d;)a(e)&&(8>d&&(h[d]=b(c.pow(e,.5))),f[d]=b(c.pow(e,1/3)),d++),e++})();var e=[],a=a.SHA256=d.extend({_doReset:function(){this._hash=new b.init(h.slice(0))},_doProcessBlock:function(a,b){for(var d=this._hash.words,c=d[0],k=d[1],h=d[2],g=d[3],m=d[4],u=d[5],z=d[6],y=d[7],n=
0;64>n;n++){if(16>n)e[n]=a[b+n]|0;else{var v=e[n-15],p=e[n-2];e[n]=((v<<25|v>>>7)^(v<<14|v>>>18)^v>>>3)+e[n-7]+((p<<15|p>>>17)^(p<<13|p>>>19)^p>>>10)+e[n-16]}v=y+((m<<26|m>>>6)^(m<<21|m>>>11)^(m<<7|m>>>25))+(m&u^~m&z)+f[n]+e[n];p=((c<<30|c>>>2)^(c<<19|c>>>13)^(c<<10|c>>>22))+(c&k^c&h^k&h);y=z;z=u;u=m;m=g+v|0;g=h;h=k;k=c;c=v+p|0}d[0]=d[0]+c|0;d[1]=d[1]+k|0;d[2]=d[2]+h|0;d[3]=d[3]+g|0;d[4]=d[4]+m|0;d[5]=d[5]+u|0;d[6]=d[6]+z|0;d[7]=d[7]+y|0},_doFinalize:function(){var a=this._data,b=a.words,e=8*this._nDataBytes,
d=8*a.sigBytes;b[d>>>5]|=128<<24-d%32;b[(d+64>>>9<<4)+14]=c.floor(e/4294967296);b[(d+64>>>9<<4)+15]=e;a.sigBytes=4*b.length;this._process();return this._hash},clone:function(){var a=d.clone.call(this);a._hash=this._hash.clone();return a}});g.SHA256=d._createHelper(a);g.HmacSHA256=d._createHmacHelper(a)})(Math);(function(){var c=CryptoJS,g=c.lib,a=g.Base,b=g.WordArray,g=c.algo,d=g.HMAC,h=g.PBKDF2=a.extend({cfg:a.extend({keySize:4,hasher:g.SHA1,iterations:1}),init:function(a){this.cfg=this.cfg.extend(a)},compute:function(a,e){for(var c=this.cfg,f=d.create(c.hasher,a),h=b.create(),g=b.create([1]),A=h.words,t=g.words,B=c.keySize,c=c.iterations;A.length<B;){var w=f.update(e).finalize(g);f.reset();for(var u=w.words,z=u.length,y=w,n=1;n<c;n++){y=f.finalize(y);f.reset();for(var v=y.words,p=0;p<z;p++)u[p]^=v[p]}h.concat(w);
t[0]++}h.sigBytes=4*B;return h}});c.PBKDF2=function(a,b,d){return h.create(d).compute(a,b)}})();/*
 MIT License (c) 2011-2013 Copyright Tavendo GmbH. */
var AUTOBAHNJS_VERSION="0.8.2",global=this;
(function(c,g){"function"===typeof define&&define.amd?define(["when"],function(a){return c.ab=g(c,a)}):"undefined"!==typeof exports?"undefined"!=typeof module&&module.exports&&(exports=module.exports=g(c,c.when)):c.ab=g(c,c.when)})(global,function(c,g){var a={_version:AUTOBAHNJS_VERSION};(function(){Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(null===this)throw new TypeError;var b=Object(this),c=b.length>>>0;if(0===c)return-1;var f=0;0<arguments.length&&(f=Number(arguments[1]),
f!==f?f=0:0!==f&&Infinity!==f&&-Infinity!==f&&(f=(0<f||-1)*Math.floor(Math.abs(f))));if(f>=c)return-1;for(f=0<=f?f:Math.max(c-Math.abs(f),0);f<c;f++)if(f in b&&b[f]===a)return f;return-1});Array.prototype.forEach||(Array.prototype.forEach=function(a,d){var b,c;if(null===this)throw new TypeError(" this is null or not defined");var e=Object(this),k=e.length>>>0;if("[object Function]"!=={}.toString.call(a))throw new TypeError(a+" is not a function");d&&(b=d);for(c=0;c<k;){if(c in e){var g=e[c];a.call(b,
g,c,e)}c++}})})();a._sliceUserAgent=function(a,d,c){var b=[],e=navigator.userAgent;a=e.indexOf(a);d=e.indexOf(d,a);0>d&&(d=e.length);c=e.slice(a,d).split(c);e=c[1].split(".");for(d=0;d<e.length;++d)b.push(parseInt(e[d],10));return{name:c[0],version:b}};a.getBrowser=function(){var b=navigator.userAgent;return-1<b.indexOf("Chrome")?a._sliceUserAgent("Chrome"," ","/"):-1<b.indexOf("Safari")?a._sliceUserAgent("Safari"," ","/"):-1<b.indexOf("Firefox")?a._sliceUserAgent("Firefox"," ","/"):-1<b.indexOf("MSIE")?
...
""};a.PrefixMap.prototype.remove=function(a){var b=this._index[a];b&&(delete this._index[a],delete this._rindex[b])};a.PrefixMap.prototype.resolve=function(a,d){var b=a.indexOf(":");if(0<=b){var c=a.substring(0,b);if(this._index[c])return this._index[c]+a.substring(b+1)}return!0===d?a:null};a.PrefixMap.prototype.shrink=function(a,d){for(var b=a.length;0<b;--b){var c=a.substring(0,b);if(c=this._rindex[c])return c+":"+a.substring(b)}return!0===d?a:null};a._MESSAGE_TYPEID_WELCOME=0;a._MESSAGE_TYPEID_PREFIX=
...
console.group("Arguments");for(var f=3;f<d._ab_callobj.length;f+=1){var h=d._ab_callobj[f];if(void 0!==h)console.log(h);else break}console.groupEnd();console.group("Result");console.log(c);console.groupEnd();console.groupEnd()}d.resolve(c)}else if(b[0]===a._MESSAGE_TYPEID_CALL_ERROR){d=e._calls[b[1]];c=b[2];f=b[3];h=b[4];if(a._debugrpc&&void 0!==d._ab_callobj){console.group("WAMP Call",d._ab_callobj[2]);console.timeEnd(d._ab_tid);console.group("Arguments");for(var k=3;k<d._ab_callobj.length;k+=1){var g=
d._ab_callobj[k];if(void 0!==g)console.log(g);else break}console.groupEnd();console.group("Error");console.log(c);console.log(f);void 0!==h&&console.log(h);console.groupEnd();console.groupEnd()}void 0!==h?d.reject({uri:c,desc:f,detail:h}):d.reject({uri:c,desc:f})}delete e._calls[b[1]]}else if(b[0]===a._MESSAGE_TYPEID_EVENT){if(d=e._prefixes.resolve(b[1],!0),d in e._subscriptions){var w=b[1],u=b[2];a._debugpubsub&&(console.group("WAMP Event"),console.info(e._wsuri+"  ["+e._session_id+"]"),console.log(w),
console.log(u),console.groupEnd());e._subscriptions[d].forEach(function(a){a(w,u)})}}else if(b[0]===a._MESSAGE_TYPEID_WELCOME)if(null===e._session_id){e._session_id=b[1];e._wamp_version=b[2];e._server=b[3];if(a._debugrpc||a._debugpubsub)console.group("WAMP Welcome"),console.info(e._wsuri+"  ["+e._session_id+"]"),console.log(e._wamp_version),console.log(e._server),console.groupEnd();null!==e._websocket_onopen&&e._websocket_onopen()}else throw"protocol error (welcome message received more than once)";
...
this._send([a._MESSAGE_TYPEID_SUBSCRIBE,b]),this._subscriptions[c]=[]);if(-1===this._subscriptions[c].indexOf(d))this._subscriptions[c].push(d);else throw"callback "+d+" already subscribed for topic "+c;};a.Session.prototype.unsubscribe=function(b,d){var c=this._prefixes.resolve(b,!0);if(c in this._subscriptions){if(void 0!==d){var f=this._subscriptions[c].indexOf(d);if(-1!==f){var e=d;this._subscriptions[c].splice(f,1)}else throw"no callback "+d+" subscribed on topic "+c;}else e=this._subscriptions[c].slice(),
this._subscriptions[c]=[];0===this._subscriptions[c].length&&(delete this._subscriptions[c],a._debugpubsub&&(console.group("WAMP Unsubscribe"),console.info(this._wsuri+"  ["+this._session_id+"]"),console.log(b),console.log(e),console.groupEnd()),this._send([a._MESSAGE_TYPEID_UNSUBSCRIBE,b]))}else throw"not subscribed to topic "+c;};a.Session.prototype.publish=function(){var b=arguments[0],d=arguments[1],c=null,f=null,e=null;if(3<arguments.length){if(!(arguments[2]instanceof Array))throw"invalid argument type(s)";
if(!(arguments[3]instanceof Array))throw"invalid argument type(s)";f=arguments[2];e=arguments[3];var g=[a._MESSAGE_TYPEID_PUBLISH,b,d,f,e]}else if(2<arguments.length)if("boolean"===typeof arguments[2])c=arguments[2],g=[a._MESSAGE_TYPEID_PUBLISH,b,d,c];else if(arguments[2]instanceof Array)f=arguments[2],g=[a._MESSAGE_TYPEID_PUBLISH,b,d,f];else throw"invalid argument type(s)";else g=[a._MESSAGE_TYPEID_PUBLISH,b,d];a._debugpubsub&&(console.group("WAMP Publish"),console.info(this._wsuri+"  ["+this._session_id+
...
(e.options.skipSubprotocolCheck=!1);void 0===e.options.skipSubprotocolAnnounce&&(e.options.skipSubprotocolAnnounce=!1);if(d)e.onConnect=d;else throw"onConnect handler required!";e.onHangup=c?c:function(b,d,c){a._debugconnect&&console.log(b,d,c)};e.connects=0;e.retryCount=0;a._connect(e)};a.launch=function(b,d,c){a.connect(b.wsuri,function(c){b.appkey&&""!==b.appkey?c.authreq(b.appkey,b.appextra).then(function(e){var f=null;"function"===typeof b.appsecret?f=b.appsecret(e):(f=a.deriveKey(b.appsecret,
JSON.parse(e).authextra),f=c.authsign(e,f));c.auth(f).then(function(b){d?d(c):a._debugconnect&&c.log("Session opened.")},c.log)},c.log):c.authreq().then(function(){c.auth().then(function(b){d?d(c):a._debugconnect&&c.log("Session opened.")},c.log)},c.log)},function(b,d,g){c?c(b,d,g):a._debugconnect&&a.log("Session closed.",b,d,g)},b.sessionConfig)};return a});ab._UA_FIREFOX=/.*Firefox\/([0-9+]*).*/;ab._UA_CHROME=/.*Chrome\/([0-9+]*).*/;ab._UA_CHROMEFRAME=/.*chromeframe\/([0-9]*).*/;ab._UA_WEBKIT=/.*AppleWebKit\/([0-9+.]*)w*.*/;ab._UA_WEBOS=/.*webOS\/([0-9+.]*)w*.*/;ab._matchRegex=function(c,g){var a=g.exec(c);return a?a[1]:a};
